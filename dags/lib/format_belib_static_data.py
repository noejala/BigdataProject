...
def formatting_stats():
    ...
    def format_static_data():
        raw_file_path = os.path.join(base_path, 'dags/lib/data/raw/belibstaticdata/belib_static_data.json')
        ...
        formatted_output_dir = os.path.join(base_path, 'dags/lib/data/formatted/belibstaticdata')
