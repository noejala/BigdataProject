...
def convert_json_to_parquet_with_spark(json_file_path, output_directory, parquet_file_name):
    ...
    try:
        with open(json_file_path, 'r') as f:
            ...
            logging.info("Data converted to RDD.")
...
base_path = '../..'
json_file_path = os.path.join(base_path, "dags/lib/data/raw/construction/construct_data.json")
output_directory = os.path.join(base_path, "dags/lib/data/formatted/construction")
